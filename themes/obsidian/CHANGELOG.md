...
> [`hexo-generator-search`](https://github.com/wzpan/hexo-generator-search), So you need to install this plugin before
...
✨Shipped a complete redesigned `archives` page UI andenhanced modern `link style`! Stay being awesome 👽!
...
🎉 Lets celebrate the new `Categories` and `Tags` page UI Now the categories page support multi-levels! Hope you guys
love this update! ❤️
